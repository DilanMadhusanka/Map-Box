...
public class MultipleRoutePathActivity extends AppCompatActivity implements OnMapReadyCallback, MapboxMap.OnMapClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiple_route_path);
